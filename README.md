...
- для аргументов **num** число в диапазоне [-2^31; 2^31 - 1] или unicode-символ в одиночных кавычках
...
- для аргументов **num** название объявленной метки или число в диапазоне [-2^31; 2^31 - 1] или unicode-символ в одиночных кавычках
